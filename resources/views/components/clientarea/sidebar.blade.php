...
<div class="left sidebar ui uncover visible expanded">
    ...
    <div class="left sidebar ui uncover visible very thin icon collapsed">
        ...
        <div class="user-avatar">
            @if ($user->avatar == null)
            <img class="ui centered small circular image" src="https://www.gravatar.com/avatar/{{ md5($user->email) }}.jpg?s=192">
            @else
        ...
        <div class="content">
            <div>
                <a class="item" href="/robotic-edit">Edit</a>
                <a class="item" href="/robotic-process">Process</a>
            </div>
        </div>
        {{-- End robotic menu --}}
...
{{-- Begin robotic menu --}}
<div class="ui left pointing dropdown link item" data-inverted="" data-tooltip="Robotic" data-position="top left">
    <i class="registered outline icon big"></i>
    <div class="menu">
        <a class="item" href="/robotic-edit">Edit</a>
        <a class="item" href="/robotic-process">Process</a>
    </div>
